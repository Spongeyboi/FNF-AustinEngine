...
class BuildingShader extends Flxfixedshaders
{
  public function new(){
...
class ChromaticAberrationShader extends Flxfixedshaders
{
	public function new(){
        @:glFragmentSource('
		////pragma header
...
class Scanline extends Flxfixedshaders
{
	public function new(){
        @:glFragmentSource('
		////pragma header
...
class Tiltshift extends Flxfixedshaders
{
	public function new(){
        @:glFragmentSource('
		////pragma header
...
class GreyscaleShader extends Flxfixedshaders{
	public function new(){
        @:glFragmentSource('
        ////pragma header
        void main() {
...
class Grain extends Flxfixedshaders
{
	public function new(){
        @:glFragmentSource('
		////pragma header
...
class VCRDistortionShader extends Flxfixedshaders // https://www.shadertoy.com/view/ldjGzV and https://www.shadertoy.com/view/Ms23DR and https://www.shadertoy.com/view/MsXGD4 and https://www.shadertoy.com/view/Xtccz4
{
...
class ThreeDShader extends Flxfixedshaders{
	public function new(){
        @:glFragmentSource('
        ////pragma header
...
class BloomShader extends Flxfixedshaders{
...
class GlitchShader extends Flxfixedshaders
{
    public function new(){
        @:glFragmentSource('
        ////pragma header
...
class InvertShader extends Flxfixedshaders
{
    public function new(){
        @:glFragmentSource('
        ////pragma header
...
class DistortBGShader extends Flxfixedshaders
{
    public function new(){
        @:glFragmentSource('
        ////pragma header
...
class PulseShader extends Flxfixedshaders
{
    public function new(){
        @:glFragmentSource('
        ////pragma header
